...
# #genericFamily
# @genericFamilyFather = GenericFamily.new(name: "GenericFamDad", description: "generic family Padre", code: "codepadre", father_id: nil, active:0)
# @genericFamilySon = GenericFamily.create(name: "GenericFamSon", description: "generic family de Hijo", code: "codehijo", active:0)

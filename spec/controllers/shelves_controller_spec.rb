...
describe ShelvesController do
  ...
  let(:valid_attributes) { { "aisle" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved shelf as @shelf" do
        ...
        post :create, {:shelf => { "aisle" => "invalid value" }}, valid_session
        assigns(:shelf).should be_a_new(Shelf)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested shelf" do
        ...
        Shelf.any_instance.should_receive(:update).with({ "aisle" => "MyString" })
        put :update, {:id => shelf.to_param, :shelf => { "aisle" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the shelf as @shelf" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Shelf.any_instance.stub(:save).and_return(false)
        put :update, {:id => shelf.to_param, :shelf => { "aisle" => "invalid value" }}, valid_session
        assigns(:shelf).should eq(shelf)
      end
